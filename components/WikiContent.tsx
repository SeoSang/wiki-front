...
import WikiModifyEditor from './WikiModifyEditor';
...
const WikiContent = React.forwardRef<
  HTMLDivElement,
  {
    item: Classification;
    groupId: string;
  ...
  return (
    <div className={classes.contentsContainer}>
      <div style={{ fontSize: '30px' }} className={classes.indexTitle}>
        ...
        {isEditorOpened.find((e) => e === groupId) ? (
          <WikiModifyEditor item={item} id={wikiSubject?.subjectId!} />
        ) : (
          ''
        )}
      </div>
