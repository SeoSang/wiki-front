    ...
    return(
        <Paper className = {classes.root}>
            <div className = {classes.titleContainer}>
                ...
                <Button onClick = {()=> router.push({pathname : 'wikiboard' , query: { subjectId : wikiSubject?.subjectId}})} variant="contained" color ="primary" className ={classes.titleButton}>{wikiSubject?.subjectName} 게시판으로 이동</Button>
            </div>
            ...
            {/* <Button className={classes.submitButton} onClick={()=> submit()}>수정 완료</Button> */}
                <WikiAddEditor open={open} handleModalClose ={()=> handleModalClose()}/>            
        </Paper>
